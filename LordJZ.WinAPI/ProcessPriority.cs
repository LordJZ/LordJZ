namespace LordJZ.WinAPI
{
    ...
    {
        /// <summary>
        /// Process that has priority above <see cref="Normal"/> but below <see cref="High"/>.
        /// </summary>
        AboveNormal = 0x00008000,

        /// <summary>
        /// Process that has priority above <see cref="Idle"/> but below <see cref="Normal"/>.
        /// </summary>
